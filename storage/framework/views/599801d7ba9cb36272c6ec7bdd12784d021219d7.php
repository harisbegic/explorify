...
<div class="row">
		<div class="col-sm-3">
		<img width="250px" height="210px" src="<?php echo e(asset('images/' . $hobby->image)); ?>"><br>
		</div>
		<div class="col-sm-9">
			<p style="font-size: 20px; font-color:black;"><strong><?php echo e($hobby->name); ?></strong>
			</p>
		...
		<div class="tab-content" id="myTabContent" style="margin-top: 7px">
		  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
		  	<?php echo e($hobby->description); ?>

		  </div>
		  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
			<?php $__currentLoopData = $hobbyphotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hobbyphoto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

				<a href="#" class="pop"><img width="140px" height="80px" src="<?php echo e(asset('photos/' . $hobbyphoto->image)); ?>">&nbsp;</a>
...
<div class="col-sm-3" style="margin-left: -15px">
			<p style="font-size: 15px; margin-top: 10px">User: &nbsp;<a href="/users/<?php echo e($hobby->user_id); ?>"><strong><?php echo e($hobby->user->name); ?></strong></a></p>
			<p style="font-size: 15px; margin-top: -18px">Category: &nbsp;&nbsp;&nbsp;<strong><?php echo e($hobby->category->name); ?></strong></p>

			<?php if($hobby->user_id == Auth::user()->id): ?>
			...
			<?php echo e(csrf_field()); ?>
					...
					<input type="hidden" name="hobby_id" value="<?php echo e($hobby->id); ?>">
      ...
      <form method="POST" action="/question/store">
        <div class="modal-body">
          <p>
			...
			<input type="hidden" name="hobby_id" class="form-control" value="<?php echo e($hobby->id); ?>">
			...
			<tr>
				<td>
					<div style="font-size: 20px">
						<b><?php echo e($question->user->name); ?></b>:<br>
					</div>
				<?php echo e($question->content); ?><br>
					<div style="font-size: 11px; margin-top: 3px">
						Posted on: <?php echo e($question->created_at); ?>
	...
	<div class="col-sm-6">
		...
		<table class="table table-hover">
			...
			<tr>
				<td>
					<div style="font-size: 20px">
						<b><?php echo e($suggestion->user->name); ?></b> said:<br>
					</div>
				<?php echo e($suggestion->content); ?><br>
					<div style="font-size: 11px; margin-top: 3px">
						Posted on: <?php echo e($suggestion->created_at); ?>
